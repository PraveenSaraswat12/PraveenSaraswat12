...
// Lightweight native <select> wrapper styled to match the shadcn look. Native
// selects are robust, keyboard/mobile-friendly, and sufficient for the
// date/zone/state filters in this ops tool.
