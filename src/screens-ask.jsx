  ...
  return (
    <div className="ask-wrap">
      ...
      <div className="voice-bar">
        ...
        <span className={`vchip ${ready?'on':''}`} title={ready?'Connected to Kithra AI through your private cloud':'Cloud not connected'}>
          <Icon name="bolt" size={14} />{ready?'Kithra AI':'Offline'}
        </span>
      ...
      <div className="ask-composer">
        {needConsent && (
          <div className="card anim-in" style={{ padding:'14px 16px', marginBottom:10, border:'1px solid color-mix(in srgb,var(--accent) 30%,transparent)', background:'var(--accent-soft)' }}>
            ...
            <p className="muted" style={{ margin:'0 0 10px', fontSize:12.5, lineHeight:1.5 }}>Your question plus recording summaries{transcribed>0?' and transcripts':''} go to Kithra AI to compose the answer — never for training, withdrawable anytime in Privacy → Consent.</p>
        ...
        <div className="center" style={{ marginTop:8 }}><span className="faint" style={{ fontSize:11.5 }}>Answers are grounded in your real recordings · powered by Kithra AI through your private cloud</span></div>
      </div>
    </div>
  );
}
